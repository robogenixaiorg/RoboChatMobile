export default {
  ...
  "error-archived-duplicate-name":
    "There's an archived channel with name {{room_name}}",
  "error-avatar-invalid-url": "Invalid avatar URL: {{url}}",
  "error-avatar-url-handling":
    "Error while handling avatar setting from a URL ({{url}}) for {{username}}",
  ...
  "error-invalid-webhook-response":
    "The webhook URL responded with a status other than 200",
  ...
  "error-too-many-requests":
    "Error, too many requests. Please slow down. You must wait {{seconds}} seconds before trying again.",
  "error-user-is-not-activated": "User is not activated",
  "error-user-has-no-roles": "User has no roles",
  "error-user-limit-exceeded":
    "The number of users you are trying to invite to #channel_name exceeds the limit set by the administrator",
  ...
  A_meaningful_name_for_the_discussion_room:
    "A meaningful name for the discussion room",
  All: "All",
  ...
  Are_you_sure_you_want_to_leave_the_room:
    "Are you sure you want to leave the room {{room}}?",
  Audio: "Audio",
  ...
  Clear_cookies_desc:
    "This action will clear all login cookies, allowing you to login into other accounts.",
  ...
  Choose_where_you_want_links_be_opened:
    "Choose where you want links be opened",
  Code: "Code",
  ...
  Discussion_Desc:
    "Help keeping an overview about what's going on! By creating a discussion, a sub-channel of the one you selected is created and both are linked.",
  ...
  E2E_How_It_Works_info2:
    "This is *end to end encryption* so the key to encode/decode your messages and they will not be saved on the server. For that reason *you need to store this password somewhere safe* which you can access later if you may need.",
  E2E_How_It_Works_info3:
  ...
  Enter_Your_Encryption_Password_desc1:
    "This will allow you to access your encrypted private groups and direct messages.",
  Enter_Your_Encryption_Password_desc2:
    "You need to enter the password to encode/decode messages every place you use the chat.",
  Encryption_error_title: "Your encryption password seems wrong",
  Encryption_error_desc:
    "It wasn't possible to decode your encryption key to be imported.",
  ...
  In_App_and_Desktop_Alert_info:
    "Displays a banner at the top of the screen when app is open, and displays a notification on desktop",
  Invisible: "Invisible",
  Invite: "Invite",
  ...
  Max_number_of_users_allowed_is_number:
    "Max number of users allowed is {{maxUsers}}",
  members: "members",
  Members: "Members",
  ...
  Omnichannel_enable_alert:
    "You're not available on Omnichannel. Would you like to be available?",
  ...
  Onboarding_join_open_description:
    "Join our open workspace to chat with the Rocket.Chat team and community.",
  ...
  Overwrites_the_server_configuration_and_use_room_config:
    "Overwrites the server configuration and use room config",
  Password: "Password",
  ...
  Push_Notifications_Alert_Info:
    "These notifications are delivered to you when the app is not open",
  Quote: "Quote",
  Reactions_are_disabled: "Reactions are disabled",
  Reactions_are_enabled: "Reactions are enabled",
  Reactions: "Reactions",
  Read: "Read",
  Read_External_Permission_Message:
    "Rocket.Chat needs to access photos, media, and files on your device",
  ...
  Room_changed_description:
    "Room description changed to: {{description}} by {{userBy}}",
  ...
  Save_Your_Encryption_Password_warning:
    "This password is not stored anywhere so save it carefully somewhere else.",
  Save_Your_Encryption_Password_info:
    "Notice that you lose your password, there is no way to recover it and you will lose access to your messages.",
  Search_Messages: "Search Messages",
  Search: "Search",
  Search_by: "Search by",
  Search_global_users: "Search for global users",
  Search_global_users_description:
    "If you turn-on, you can search for any user from others companies or servers.",
  ...
  Show_Unread_Counter_Info:
    "Unread counter is displayed as a badge on the right of the channel, in the list",
  ...
  Theme: "Theme",
  The_user_wont_be_able_to_type_in_roomName:
    "The user won't be able to type in {{roomName}}",
  The_user_will_be_able_to_type_in_roomName:
    "The user will be able to type in {{roomName}}",
  ...
  Verify_email_desc:
    "We have sent you an email to confirm your registration. If you do not receive an email shortly, please come back and try again.",
  Verify_your_email_for_the_code_we_sent:
    "Verify your email for the code we sent",
  ...
  Write_External_Permission_Message:
    "Rocket.Chat needs access to your gallery so you can save images.",
  ...
  You_need_to_access_at_least_one_RocketChat_server_to_share_something:
    "You need to access at least one Rocket.Chat server to share something.",
  You_need_to_verifiy_your_email_address_to_get_notications:
    "You need to verify your email address to get notifications",
  Your_certificate: "Your Certificate",
  Your_invite_link_will_expire_after__usesLeft__uses:
    "Your invite link will expire after {{usesLeft}} uses.",
  Your_invite_link_will_expire_on__date__or_after__usesLeft__uses:
    "Your invite link will expire on {{date}} or after {{usesLeft}} uses.",
  ...
  You_will_unset_a_certificate_for_this_server:
    "You will unset a certificate for this server",
  Change_Language: "Change Language",
  Crash_report_disclaimer:
    "We never track the content of your chats. The crash report and analytics events only contains relevant information for us in order to identify and fix issues.",
  ...
  This_will_remove_all_data_from_this_server:
    "This will remove all data from this server.",
  ...
  You_will_be_logged_out_from_other_locations:
    "You'll be logged out from other locations.",
  Logged_out_of_other_clients_successfully:
    "Logged out of other clients successfully",
  ...
  E2E_encryption_change_password_error:
    "Error while changing E2E key password!",
  E2E_encryption_change_password_success:
    "E2E key password changed successfully!",
  E2E_encryption_change_password_message:
    "Make sure you've saved it carefully somewhere else.",
  E2E_encryption_change_password_confirmation: "Yes, change it",
  E2E_encryption_reset_title: "Reset E2E Key",
  E2E_encryption_reset_description:
  ...
  User__username__is_now_a_leader_of__room_name_:
    "User {{username}} is now a leader of {{room_name}}",
  User__username__is_now_a_moderator_of__room_name_:
    "User {{username}} is now a moderator of {{room_name}}",
  User__username__is_now_a_owner_of__room_name_:
    "User {{username}} is now a owner of {{room_name}}",
  User__username__removed_from__room_name__leaders:
    "User {{username}} removed from {{room_name}} leaders",
  User__username__removed_from__room_name__moderators:
    "User {{username}} removed from {{room_name}} moderators",
