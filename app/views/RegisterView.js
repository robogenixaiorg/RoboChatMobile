...
class RegisterView extends React.Component {
  static navigationOptions = ({ route, navigation }) => ({
    ...
    headerRight: () => (
      <HeaderButton.Legal testID="register-view-more" navigation={navigation} />
    ),
  });
  ...
  submit = async () => {
    ...
    try {
      ...
      if (Accounts_EmailVerification) {
        ...
        await navigation.goBack();
        showErrorAlert(
          I18n.t("Wait_activation_warning"),
          I18n.t("Registration_Succeeded")
        );
      } else {
          ...
          return (
            <RNPickerSelect
              ...
              onValueChange={(value) => {
                ...
                newValue[key] = value;
                this.setState({
                  customFields: { ...customFields, ...newValue },
                });
              }}
      ...
      >
        ...
        <View style={styles.bottomContainer}>
          <Text style={[styles.bottomContainerText, { color: "black" }]}>
            ...
            <Text
              style={[styles.bottomContainerTextBold, { color: "blue" }]}
